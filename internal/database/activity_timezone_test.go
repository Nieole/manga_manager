// 业务说明：本文件守卫「阅读活动的日期与 last_read_at 用同一套日历」。
//
// 活动日期此前走 SQLite 的 DATE('now')（UTC 日历日），而 last_read_at 落库时是本地墙钟串。
// 两套日历在跨零点的时段会分裂：UTC+8 时区、本地 2026-01-01 07:00 读完一本书，
// 活动记成 2025-12-31、last_read_at 前缀是 2026-01-01 —— 年度回顾里「读完的书」算进 2026、

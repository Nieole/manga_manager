...
var apiMessages = map[string]map[string]string{
	"zh-CN": {
		...
		"comicinfo.write.not_mergeable": "归档里已有的 ComicInfo.xml 不是 UTF-8 或语法有误，无法在不损坏原有字段的前提下合并，已跳过。",
	...
	"en-US": {
		...
		"comicinfo.write.not_mergeable": "The archive's existing ComicInfo.xml is not UTF-8 or is malformed, so it cannot be merged without losing its fields; skipped.",
		...
		"auth.password_change_required": "You must change your initial password before continuing.",

...
export const modalInputClass =
  'w-full rounded-xl border border-gray-700 bg-gray-950/80 px-4 py-3 text-sm text-white placeholder-gray-500 shadow-inner shadow-black/20 outline-none transition-all focus:border-komgaPrimary/50 focus:ring-2 focus:ring-komgaPrimary/20';

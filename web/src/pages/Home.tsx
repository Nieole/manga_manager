                        ...
                        {aiRecommendations.map((rec, i) => (
                            ...
                            >
                                <div className="w-20 aspect-[2/3] shrink-0 bg-black rounded-lg overflow-hidden relative border border-gray-800">
                                    {rec.cover_path ? (
                                        <img src={`/api/thumbnails/${rec.cover_path}`} alt={rec.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                                    ) : (
                                ...
                                <div className="flex flex-col flex-1 py-1 overflow-hidden">
                                    <h4 className="font-bold text-gray-200 text-sm mb-1.5 line-clamp-1 group-hover:text-komgaPrimary transition-colors">{rec.title}</h4>

    ...
    <div className="space-y-6">
      ...
      <section className={sectionClassName}>
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <button onClick={() => handleAction('/api/system/rebuild-index', t('settings.maintenance.rebuildIndexSuccess'))} className="rounded-xl border border-red-500/20 bg-red-500/10 px-4 py-4 text-left text-red-200 hover:bg-red-500/15">
          ...
          <button onClick={() => handleAction('/api/system/rebuild-thumbnails', t('settings.maintenance.rebuildThumbnailsSuccess'))} className="rounded-xl border border-red-500/20 bg-red-500/10 px-4 py-4 text-left text-red-200 hover:bg-red-500/15">
          ...
          <button onClick={() => handleAction('/api/system/batch-scrape', t('settings.maintenance.batchScrapeSuccess'))} className="rounded-xl border border-red-500/20 bg-red-500/10 px-4 py-4 text-left text-red-200 hover:bg-red-500/15">
